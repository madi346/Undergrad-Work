...
void Tester::Test_ShiftRight()
{
	...
	cout << "Item at index 4 is " << *testSR.Get(4) << endl;
...
{
	DrawLine();
	cout << endl << "TEST: Test_ShiftLeft" << endl;
	...
	cout << "Item at index 1 is " << *testSL.Get(1) << endl;
...
{
	DrawLine();
	cout << endl << "TEST: Test_IsFull" << endl;
...
{
	DrawLine();
	cout << endl << "TEST: Test_PushFront" << endl;
	...
	cout << "size of list " << testPf.Size() << endl;
	...
	cout << "size of list " << testPf2.Size() << endl;
	if (actualValue == expectedValue) {
		cout << "test passed" << endl;
	}
	else {
...
{
	DrawLine();
	cout << endl << "TEST: Test_PushBack" << endl;
	...
	cout << "size of list " << testPb.Size() << endl;
	...
	cout << "size of list " << testPb2.Size() << endl;
...
{
	DrawLine();
	cout << endl << "TEST: Test_PopFront" << endl;
	...
	cout << "\nitem at front of list " << *testPopf.GetFront() << endl;
...
{
	DrawLine();
	cout << endl << "TEST: Test_PopBack" << endl;
	...
	cout << "\nitem at back of list " << *testPopb.GetBack() << endl;
...
{
	DrawLine();
	cout << endl << "TEST: Test_Clear" << endl;
	...
	testClr.Clear();
	cout << "size of list " << testClr.Size() << endl;
...
{
	DrawLine();
	cout << endl << "TEST: Test_GetFront" << endl;
...
{
	DrawLine();
	cout << endl << "TEST: Test_GetBack" << endl;
...
{
	DrawLine();
	cout << endl << "TEST: Test_GetCountOf" << endl;
...
{
	DrawLine();
	cout << endl << "TEST: Test_Contains" << endl;
...
{
	DrawLine();
	cout << endl << "TEST: Test_Remove" << endl;
	...
	cout << "\nitem at index 3 " << *listR.Get(3) << endl;
	...
	cout << "\nitem at index 1 " << *listR3.Get(1) << endl;
	...
	cout << endl << "TEST: Test_RemoveIndex" << endl;
	// test 1
	cout << "test 1" << endl;
	...
	cout << "\nitem at index 1 " << *listRI.Get(1) << endl;
	...
	cout << "size of list " << listRI2.Size() << endl;
...
{
	DrawLine();
	cout << endl << "TEST: Test_Insert" << endl;
	...
	cout << "size of list " << listI.Size() << endl;
	...
	cout << "size of list " << listI2.Size() << endl;
